...
- Venda pela **Cakto** (pagamento único, acesso vitalício):
  ...
  - Oferta PRO R$ 15,00 — https://pay.cakto.com.br/wx9esqb_1139423
    (aparece no popup ao clicar no Básico e no botão de upgrade dentro do app)
...
- Reembolso/chargeback do Básico ou PRO apaga o acesso.
- Reembolso da oferta de R$ 15: se a pessoa comprou só ela, o acesso é apagado;
  se já tinha o Básico antes, volta para o Básico.
